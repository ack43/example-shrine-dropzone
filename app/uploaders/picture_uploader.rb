  ...
  process(:store) do |io|
    {
      ...
      # Original
      sm: resize_to_fit!(io.download, 350, 350),
      md: resize_to_fit!(io.download, 600, 600),
      lg: resize_to_fit!(io.download, 1200, 1200),

      # Squares
      sm_square: resize_to_fill!(io.download, 350, 350),
      md_square: resize_to_fill!(io.download, 600, 600),
      lg_square: resize_to_fill!(io.download, 1200, 1200),
    }
  end
end